...
__Educational tip__: we should represent the concept of an activity using an interface. Each activity
...
__Real-world use case__: in a real-world application you may use a workflow in a scenario like the
following:
